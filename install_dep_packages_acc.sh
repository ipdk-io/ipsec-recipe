...
if git clone https://github.com/gflags/gflags.git  ${SRC_DIR}/$MODULE >/dev/null ; then
    echo "Cloning done"
else
    echo "'$MODULE' existing! proceeding with build and install"
fi
cd $SRC_DIR/$MODULE
...
echo "####  Cloning, Building and Installing the '$MODULE' module ####"
mkdir -p ${SRC_DIR}/$MODULE
if git clone https://github.com/google/glog.git  ${SRC_DIR}/$MODULE >/dev/null ; then
    echo "Cloning done"
else
    echo "'$MODULE' existing! proceeding with build and install"
fi
...
echo "####  Cloning, Building and Installing the '$MODULE' module ####"
mkdir -p ${SRC_DIR}/$MODULE
if git clone https://github.com/abseil/abseil-cpp.git  ${SRC_DIR}/$MODULE >/dev/null ; then
    echo "Cloning done"
else
    echo "'$MODULE' existing! proceeding with build and install"
fi
...
echo "####  Cloning, Building and Installing the '$MODULE' module ####"
mkdir -p ${SRC_DIR}/$MODULE
if git clone https://github.com/google/cctz.git  ${SRC_DIR}/$MODULE >/dev/null ; then
    echo "Cloning done"
else
    echo "'$MODULE' existing! proceeding with build and install"
fi
...
echo "####  Cloning, Building and Installing the '$MODULE' module ####"
mkdir -p ${SRC_DIR}/$MODULE
if git clone https://github.com/google/protobuf.git  ${SRC_DIR}/$MODULE >/dev/null ; then
    echo "Cloning done"
else
    echo "'$MODULE' existing! proceeding with build and install"
fi
...
echo "####  Cloning, Building and Installing the '$MODULE' module ####"
mkdir -p ${SRC_DIR}/$MODULE
if git clone https://github.com/nlohmann/json.git  ${SRC_DIR}/$MODULE >/dev/null ; then
    echo "Cloning done"
else
    echo "'$MODULE' existing! proceeding with build and install"
fi
...
echo "####  Cloning, Building and Installing the '$MODULE' module ####"
mkdir -p ${SRC_DIR}/$MODULE
if git clone https://github.com/google/grpc.git  ${SRC_DIR}/$MODULE >/dev/null ; then
    echo "Cloning done"
else
    echo "'$MODULE' existing! proceeding with build and install"
fi
